...
This way, it is in our best interest to obtain the diagrams at each order that contribute
to the gluon's self-energy, and thus the effective mass. 

At order 2, the diagram that contribute to the gluon's self-energy presented in figure 
\ref{fig:order2_from_order1/3}  and \ref{fig:order2_from_order1/counterterms}, 
the only diagrams from one gluon to one gluon.
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[t]{0.19\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/order4_1to1/counterterms/2.png}
        \caption{ }
    ...
    with (h)-(l) diagrams with counterterms of order 2, and (m) the counterterm 
    of order 4}
