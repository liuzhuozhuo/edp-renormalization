...
space and thus is implemented in Hamiltonian dynamics.

\subsubsection{Noether's theorem}

A Hamiltonian can be derived from the Lagrangian of the theory by the means of Noether'S
theorem. Noether's theorem \cite{Noether1918, Peskin:1995ev} states that every continuous 
...
of quantum field theory, formulated by S.D.Głazek and K.G.Wilson \cite{PhysRevD.48.5863 ,glazek_dynamics_2001, PEP}. 
...
and so on, without considering the RGPEP factors,
